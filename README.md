...
The entire framework is organized into three modules, which are also reflected in the GitHub repository:
...
Running this module generates:

Preprocessed Sentinel-2 and MODIS images at common dates and resolutions (500 m) stored in Google Drive.

High-resolution Sentinel-2 band stacks and indices (10 m), which are used in Module 3 to produce the final high-resolution albedo product.

Module 2: Data Preparation for Machine Learning

Machine learning and deep learning models require tabular or array-based inputs, so this module converts the preprocessed imagery into a suitable format:
